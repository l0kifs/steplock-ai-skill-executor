...
2. **Trusted Publishing**: Configure trusted publishing (no API tokens needed!) at [https://pypi.org/manage/account/publishing/](https://pypi.org/manage/account/publishing/)
   - Add a new publisher with:
     - PyPI Project Name: `steplock`
     - Owner: `l0kifs`
     - Repository name: `steplock-ai-skill-executor`
...
2. **Update version** in `src/pytest_beacon/settings.py`:
   ```python
...
3. **Create a GitHub release**:
   ...
   ## 🔗 Full Changelog
   See [CHANGELOG.md](https://github.com/l0kifs/steplock-ai-skill-executor/blob/v0.2.0/CHANGELOG.md)"
   ```
   
   Or using GitHub web interface:
   - Go to [https://github.com/l0kifs/steplock-ai-skill-executor/releases/new](https://github.com/l0kifs/steplock-ai-skill-executor/releases/new)
...
3. Test installation:
   ```bash
   pip install --index-url https://test.pypi.org/simple/ steplock
   ```
